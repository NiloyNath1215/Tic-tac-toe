...
time.sleep(0.5)
print('This game is made by Niloy Nath\n')
...
def win_check():
    ...
    if O_win:
        win = True
        return print('Winner is', u2.upper()), win
    if X_win:
        win = True
        return print('Winner is', u1.upper(), '\n--Game Ends--\n'), win
...
|                         | this Game                                 |''')
        ...
        print('Hello,')
        print('      My self Tic-tac-toe and I was created by Niloy.')
        print('      E-mail: skanniloy@gmail.com')
        ...
        if duo_ai == 'friend' or duo_ai == 'f' or duo_ai == 'my friend' or duo_ai == 'duo' or duo_ai == 'human':
            game_on = True
            print('Hello, I am jErRy, the A.I. and I am your umpire today.')
            u1 = input('What should I call you player 1(X)? ')
            u2 = input('What should I call you player 2(O)? ')
            print("Let's see who wins today.")
            print("Let's start with the game now", u1.upper(), 'vs', u2.upper(), '\n\n')
            ...
            print('Hello, I am jErRy, the A.I. and I am your opponent today.')
            u1 = input('What should i call you? ')
            print("let's see if you can beat me.")
            u2 = 'bot'
            print("Let's start with the game now", u1.upper(), '\n\n')
            print("Type 'Rule' to see Rules.")
            print(' ', 1, '|', 2, '|', 3, '\n ---------- \n', '', 4, '|', 5, '|', 6, '\n ----------\n', '', 7,
                  '|', 8, '|', 9, '\n')
            game_on = True
